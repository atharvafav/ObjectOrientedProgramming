...
public class ClientSide {
        public static void main(String[] args) {
 	       ...
 	       try {
			      ...
			      InetAddress h=InetAddress.getByName("100.100.152.10"); //Destination IP address
			      int sSocket=9990;
			   ...
			   while(i<=10)  //Sending 10 data packets
			    {
			     ...
			     for(j=0;j<4;j++)           //Loop of 4--[1 for normal transmission of data and 3 for re-transmission incase of failure
			     {
			      try {		    	  
			             /*if(i==7)
			             {
			            	 if(j==0||j==1) //[BUG 1]...The 7th data packet is corrupted and correct data packet is sent during the 3rd re-transmission
			            		 data[0]=0;
			            	 else
			            		 data[0]=51;
			             }*/
